    ...
    <div className="mx-auto max-w-4xl">
      <div className="space-y-6 text-lg leading-relaxed text-gray-700">
        <p className="text-xl font-semibold text-gray-900">
          ...
          become known for delivering high-quality, cost-effective construction
          solutions.
        </p>
        ...
        <div className="mt-8 rounded-lg border-l-4 border-primary-500 bg-gray-50 p-6">
          ...
          <ul className="space-y-2 text-gray-700">
            <li className="flex items-start">
              ...
              <span>
                <strong>Reliability:</strong> Dependable service you can count
                on, every time
              </span>
            </li>
            <li className="flex items-start">
              <span className="mr-2 text-primary-500">✓</span>
              <span>
                <strong>Craftsmanship:</strong> Attention to detail in every
            ...
            <li className="flex items-start">
              <span className="mr-2 text-primary-500">✓</span>
              <span>
                <strong>Integrity:</strong> Honest communication and ethical
                business practices
              </span>
            </li>
          </ul>
