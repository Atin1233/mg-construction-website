    ...
    <div className="mx-auto max-w-4xl">
      <div className="rounded-lg bg-gradient-to-r from-gray-800 to-gray-900 p-8 text-white shadow-xl">
        ...
        <p className="text-lg leading-relaxed text-gray-100">
          ...
          municipalities throughout New Jersey. Our expertise spans a wide range
          of commercial construction projects, from large-scale developments to
          municipal infrastructure improvements.
        </p>
        <p className="mt-4 text-lg leading-relaxed text-gray-100">
          We understand the unique demands of commercial construction, including
          strict timelines, budget constraints, and quality requirements. Our
          team is equipped to handle complex projects while maintaining our
